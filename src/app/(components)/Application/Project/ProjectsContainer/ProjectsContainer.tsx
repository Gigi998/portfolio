...
const ProjectsContainer = async () => {
  return (
    <div className='flex flex-col justify-center gap-x-10 mt-10'>
      <div className='text-secondary text-body-1 px-56 text-center'>
        I've worked on many smaller projects that are visible on my GitHub.
        However, these two projects were particularly impactful in expanding my
        knowledge and sharpening my skills as a developer. They had the greatest
